...
class GradioContentAutomationUI:
    ...
    def create_ui(self):
        ...
        with gr.Tab("Generate Videos") as self.content_automation_ui:
            gr.Markdown("# 🏆 GYANZ.AI can aid in creation of knowledge videos 🚀")
            #gr.Markdown("## Choose your desired automation task.")
            # choice = gr.Radio(['🎬 Automate the creation of shorts', '🎞️ Automate a video with stock assets', '🌐 Automate multilingual video dubbing'], label="Choose an option", value = "🎞️ Automate a video with stock assets")
